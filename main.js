...
let canvasSq = document.querySelectorAll(".canvas div")
...
//mousedown checks if user left click and holds
//mouseup checks for when use releases that left click
